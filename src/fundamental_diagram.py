...
class FundamentalDiagram:
    ...
    def __init__(self, freeflow_speed: float, jam_density: float, traffic_wave_speed: float):
        ...
        self.capacity_density = (traffic_wave_speed * jam_density) / (traffic_wave_speed + freeflow_speed)
        ...
        self.func = interpolate.interp1d([0, self.capacity_density, jam_density], [0, self.capacity, 0])
